    ...
    <div className="new-dashboard-bg">
      ...
      <div className="new-dashboard-header">
        ...
        <div className="new-dashboard-actions">
          <button className="new-employees-btn" onClick={() => setShowEmployeeManagement(true)}>
            <FaUsers /> Employees
          </button>
          <button className="new-assign-btn" onClick={() => {
          setShowAssignTask(true);
          if (employees.length > 0) {
            setAssignableUsers(employees);
          }
          }}>Assign Tasks</button>
          <button className="new-menu-btn" onClick={() => setIsMenuOpen((v) => !v)}>
            <BsThreeDotsVertical />
        </button>
        {isMenuOpen && (
            <div className="new-menu-dropdown">
            {menuOptions.map((opt, i) => (
                <div className="new-menu-option" key={i} onClick={() => handleMenuSelect(opt)}>{opt}</div>
            ))}
          </div>
        )}
        </div>
        ...
        <div className="assign-task-overlay">
          <div className="assign-task-modal">
            <div className="assign-task-header">
              <h2>Assign Tasks</h2>
              <button className="assign-task-close" onClick={() => setShowAssignTask(false)}>×</button>
            </div>
            
            {taskError && <div className="assign-task-error">{taskError}</div>}
            {taskSuccess && <div className="assign-task-success">{taskSuccess}</div>}
            ...
            <form className="assign-task-form" onSubmit={handleAssignTask}>
              ...
              <div className="form-actions">
                ...
                <button type="submit" disabled={taskLoading} className="assign-btn">
                  {taskLoading ? 'Assigning...' : 'Assign Tasks'}
                </button>
              </div>
            </form>
          </div>
      ...
      <div className="new-dashboard-content">
        ...
        <div className="new-section">
          <div className="new-section-header">
            <h2>Leads</h2>
            <p>Monitor, convert, and grow your potential opportunities.</p>
        </div>
          <div className="new-cards-grid">
            <div className="new-card">
              <div className="new-card-header">
                <div className="new-card-icon">👥</div>
                <div className="new-card-menu">⋮</div>
                        </div>
              <div className="new-card-content">
                <div className="new-card-value">50.8K</div>
                <div className="new-card-trend positive">18.4%↑</div>
                <div className="new-card-chart">
                  <svg width="100%" height="30" viewBox="0 0 200 30" className="area-chart">
                    <defs>
                    ...
                    <path d="M0,25 C30,20 60,15 90,18 C120,12 150,8 180,10 L180,30 L0,30 Z" 
                          fill="url(#gradient1)"/>
                    <path d="M0,25 C30,20 60,15 90,18 C120,12 150,8 180,10" 
                          stroke="#4CAF50" 
                          strokeWidth="2" 
                          fill="none"/>
                  </svg>
              ...
              <div className="new-card-title">Active Leads</div>
                    </div>
            ...
            <div className="new-card">
              ...
              <div className="new-card-content">
                <div className="new-card-value">30.8K</div>
                <div className="new-card-trend negative">18.4%↓</div>
                <div className="new-card-chart">
                  <svg width="100%" height="30" viewBox="0 0 200 30" className="area-chart">
                    <defs>
                    ...
                    <path d="M0,8 C30,12 60,18 90,15 C120,22 150,25 180,28 L180,30 L0,30 Z" 
                          fill="url(#gradient2)"/>
                    <path d="M0,8 C30,12 60,18 90,15 C120,22 150,25 180,28" 
                          stroke="#f44336" 
                          strokeWidth="2" 
                          fill="none"/>
                  </svg>
              ...
              <div className="new-card-title">Lost Leads</div>
            </div>
            ...
            <div className="new-card">
              ...
              <div className="new-card-content">
                ...
                <div className="new-card-chart">
                  <svg width="100%" height="30" viewBox="0 0 200 30" className="area-chart">
                    ...
                    <path d="M0,22 C30,18 60,12 90,15 C120,8 150,5 180,7 L180,30 L0,30 Z" 
                          fill="url(#gradient3)"/>
                    <path d="M0,22 C30,18 60,12 90,15 C120,8 150,5 180,7" 
                          stroke="#4CAF50" 
                          strokeWidth="2" 
                          fill="none"/>
                  </svg>
              ...
              <div className="new-card-title">Leads Without Tasks</div>
            </div>
          </div>
        </div>
        ...
        <div className="new-section">
          <div className="new-section-header">
            <h2>Conversations</h2>
            <p>Track and optimize your customer interactions in real-time.</p>
          </div>
          <div className="new-cards-grid">
            <div className="new-card">
              <div className="new-card-header">
              ...
              <div className="new-card-content">
                <div className="new-card-value">10.8K</div>
                <div className="new-card-trend positive">18.4%↑</div>
              </div>
              <div className="new-card-title">Incoming Messages</div>
            </div>
            ...
            <div className="new-card">
              ...
              <div className="new-card-content">
                <div className="new-card-value">5.4K</div>
              </div>
              <div className="new-card-title">Ongoing Conversations</div>
            </div>
            ...
            <div className="new-card">
              ...
              <div className="new-card-content">
                <div className="new-card-value">20.3K</div>
                <div className="new-card-trend positive">18.4%↑</div>
              </div>
              <div className="new-card-title">Unanswered Conversations</div>
            </div>
            ...
            <div className="new-card">
              ...
              <div className="new-card-content">
                <div className="new-card-value">8K</div>
                <div className="new-card-trend positive">18.4%↑</div>
              </div>
              <div className="new-card-title">Longest Awaiting Reply</div>
            </div>
          </div>
        </div>
        ...
        <div className="new-section">
          <div className="new-section-header">
            <h2>Tasks</h2>
            <p>Stay on top of your team's progress and productivity.</p>
          </div>
          <div className="new-cards-grid">
            <div className="new-card">
              <div className="new-card-header">
              ...
              <div className="new-card-title">Tasks</div>
            </div>
          </div>
        </div>
          ...
          <div className="employee-modal-overlay">
            <div className="employee-modal-content">
              <div className="employee-modal-header">
                <h2>Employee</h2>
                <button className="employee-modal-close" onClick={() => setShowEmployeeManagement(false)}>×</button>
              </div>

              {userError && <div className="employee-modal-error">{userError}</div>}
              {userSuccess && <div className="employee-modal-success">{userSuccess}</div>}

              <div className="employee-modal-actions">
                <button 
                  className="employee-add-new-btn"
                ...
                <div className="add-user-modal-overlay">
                  <div className="add-user-modal-content">
                    <div className="add-user-modal-header">
                      <h2>Employee</h2>
                      <button className="add-user-modal-close" onClick={() => setShowAddUserForm(false)}>×</button>
                    </div>
                    ...
                    <div className="add-user-form-section">
                      ...
                      <form onSubmit={handleCreateUser}>
                        ...
                        <div className="form-actions">
                          ...
                          <button type="submit" disabled={userLoading} className="add-btn">
              ...
              <div className="employee-modal-list">
                ...
                {userLoading && <div className="employee-modal-loading">Loading users...</div>}
                
                {!userLoading && employees.length === 0 && (
                  <div className="employee-modal-empty">
                ...
                {!userLoading && employees.length > 0 && (
                  <div className="employee-data-table">
                    <div className="employee-data-header">
                      <div className="employee-data-cell">Client Name</div>
                      <div className="employee-data-cell">Email Id</div>
                      <div className="employee-data-cell">Status</div>
                      <div className="employee-data-cell">Date</div>
                      <div className="employee-data-cell">Action</div>
                    </div>
                    
                    {employees.map((employee) => (
                      <div key={employee.id} className="employee-data-row">
                        <div className="employee-data-cell">
                          <div className="employee-data-name">
                            {employee.name}
                          </div>
                        </div>
                        <div className="employee-data-cell">{employee.email}</div>
                        <div className="employee-data-cell">
                        ...
                        <div className="employee-data-cell">
                          <div className="employee-data-actions">
                            <button 
